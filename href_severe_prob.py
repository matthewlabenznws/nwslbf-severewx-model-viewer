...
# Uploads runs.json and PNGs to runs/mesoensprob/href/severe_prob/
# ============================================================
...
DATA_DIR = os.path.join(BASE_DIR, "href_severe_prob_subsets")
...
def plot_domain_from_fields(fields, domain_key, cfg, fhr):
    ...
    try:
        ...
        cbar.set_label(
            "Probability of 2-5 km UH > 75 m²/s² (%)",
            fontsize=10,
            weight="bold"
        )
        ...
        outname = os.path.join(domain_outdir, f"href_severe_prob_f{fhr:02d}.png")
...
print("Done. Uploaded HREF severe probability to R2:", R2_PRODUCT_PATH)
