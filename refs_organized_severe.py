...
# Uploads runs.json and PNGs to runs/mesoensprob/refs/organized_severe/
# ============================================================
...
DATA_DIR = os.path.join(BASE_DIR, "refs_organized_severe_subsets")
...
def plot_domain_from_fields(fields, domain_key, cfg, fhr):
    ...
    try:
        ...
        outname = os.path.join(domain_outdir, f"refs_organized_severe_f{fhr:03d}.png")
...
print("Done. Uploaded REFS organized severe ingredients probability to R2:", R2_PRODUCT_PATH)
