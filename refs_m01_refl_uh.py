# ============================================================
# REFS M01 | R2 CAMs Product
# Reflectivity + UH + Sim IR + Theta Cold Pools + 4–6 km SR Winds
# Uploads runs.json and PNGs to runs/cams/refs/m01/refl_uh/
# ============================================================
...
DATA_DIR = os.path.join(BASE_DIR, "refs_m01_subsets")
...
def plot_domain_from_fields(fields, domain_key, cfg, fhr):
    ...
    try:
        ...
        outname = os.path.join(domain_outdir, f"refs_m01_lbf_f{fhr:03d}.png")
...
print("Done. Uploaded REFS M01 reflectivity/UH to R2:", R2_PRODUCT_PATH)
