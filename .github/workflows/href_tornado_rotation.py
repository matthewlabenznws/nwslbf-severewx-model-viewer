...
# Uploads runs.json and PNGs to runs/mesoensprob/href/tornado_rotation/
# ============================================================
...
DATA_DIR = os.path.join(BASE_DIR, "href_tornado_rotation_subsets")
...
def plot_domain_from_fields(fields, domain_key, cfg, fhr):
    ...
    try:
        ...
        outname = os.path.join(domain_outdir, f"href_tornado_rotation_f{fhr:02d}.png")
...
print("Done. Uploaded HREF tornado/rotating storm support probability to R2:", R2_PRODUCT_PATH)
