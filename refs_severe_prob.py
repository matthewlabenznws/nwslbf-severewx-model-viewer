...
# Uploads runs.json and PNGs to runs/mesoensprob/refs/severe_prob/
# ============================================================
...
DATA_DIR = os.path.join(BASE_DIR, "refs_severe_prob_subsets")
...
def plot_domain_from_fields(fields, domain_key, cfg, fhr):
    ...
    main_title = (
        f"{MODEL_LABEL} | Fill: 2-5 km UH > 75 m²/s² Probability | "
    ...
    outname = os.path.join(domain_outdir, f"refs_severe_prob_f{fhr:03d}.png")
